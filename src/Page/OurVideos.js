...
import HeroSection from "../components/Home/HeroVideoGalVid";
        ...
        <BaseLayout PageName="Our Videos">
            <div className="md:max-w-full w-full">
                <HeroSection
                    ...
                    urlVideo={"https://firebasestorage.googleapis.com/v0/b/videostock-8dab7.appspot.com/o/video%2FSala%20stock.mp4?alt=media&token=1bfe58c7-9cde-42df-8497-5cd3f7557df9"}
                />
            </div>
