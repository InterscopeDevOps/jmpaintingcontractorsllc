  ...
  return (
    <>
      <div className="w-full flex justify-center bg-gray-400 bg-opacity-5 p-3 py-14 bg-footer text-white">
        <div className="md:max-w-screen-lg w-full">
          <div className="block md:grid md:grid-cols-2 md:gap-5 lg:gap-7 lg:grid-flow-col">
            ...
            <div className="pt-10">
              <h5>About</h5>
              <p className="pb-4">{rpdata?.dbAbout?.[1].text.substring(0, 196) + '...'}</p>
            </div>
            <div className="pt-10">
              <h5>Navigation</h5>
              <ul className="pl-2">
            ...
            <div className="pt-10">
              ...
              <ul className="pl-2">
                ...
                {rpdata?.dbPrincipal?.workdays.map((item, index) => {
                  return (
                    <li className="py-2 flex flex-col items-start" key={index} >
                      <div className="flex">
                      ...
                      <div className="flex">
                        <FiClock fontSize={25} />
                      <span className="pl-3">{rpdata?.dbPrincipal?.workHours?.[index].hour}</span>
                      </div>                    
                    </li>
                  );
                })}
      ...
      <div className="w-full flex justify-around md:flex-row items-center flex-col-reverse text-center text-white  py-4 bg-[#3B5997]">
        <p>
          {datetime.getFullYear()}, Copyright By {rpdata?.dbPrincipal?.name}. All Rights Reserved
        </p>
        <ul className="flex">
