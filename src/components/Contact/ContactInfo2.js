    ...
    const contentInfo = [
        {
            ...
            icon: <FaCalendarAlt fontSize={45} color={'#AD0D0D'} />,
        },
        {
        ...
        <>
            ...
            <div className='w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 mt-10'>
                <div className='relative'>
                    <div className='absolute bg-[#B146B1] w-[40%] h-[60%] -z-10'></div>
                    <div className='mt-10 ml-[30px] md:ml-[50px] px-5 md:px-[40px] pt-[80px] bg-white'>
                        <h2>Get In Touch!</h2>
                        <p className='pb-5'>{rpdata?.dbValues?.[2].description}</p>
                        <div className='grid grid-cols-1 lg:grid-cols-2'>
                            <div className='flex mb-5'>
                                <div className='self-center'>
                                    <FiNavigation fontSize={45} color={'#AD0D0D'} />
                                </div>
                                <div className='self-center px-3'>
                                    <p className='text-[20px] font-normal'>Location</p>
                                    <p className=' font-medium'>{rpdata?.dbPrincipal?.location?.[0].address}</p>
                                </div>
                            </div>
                            <div className='flex mb-5'>
                                <div className='self-center'>
                                    <FiPhoneCall fontSize={45} color={'#AD0D0D'} />
                                </div>
                                <div className='self-center px-3'>
                                    ...
                                    return (
                                        <div key={index} className='flex mb-5'>
                                            ...
                                            <div className='self-center px-3'>
                                                ...
                                                <p className=' font-medium capitalize'>{items.subTitle}</p>
                                            </div>
            ...
            <div className="w-full flex justify-center">
                <div className="flex w-[1100px] py-24 md:flex-row flex-col text-center md:text-start">
                    <div
                        ...
                        style={{ backgroundImage: `url("${rpdata?.gallery?.[14]}")` }}
                    ></div>
